...
config = create_custom_monte_carlo_config(
    ...
    sand_residual_co2_saturation=(0.15, 0.25),           # ±25% around 0.2
    sand_irreducible_water_saturation=(0.24, 0.36),      # ±20% around 0.3
    shale_pressure_threshold=(80000.0, 116000.0),        # ±18% around 98000 Pa
    leakage_height=(16.0, 24.0),                         # ±20% around 20 m
...
println("\n" * "="^80)
println("MONTE CARLO ANALYSIS COMPLETED SUCCESSFULLY!")
println("="^80)
println("\nResults saved to: monte_carlo_results/")
println("\nGenerated files:")
println("  - Uncertainty plots (PNG)")
println("  - Statistical summaries (CSV)")
println("  - Raw ensemble data (JLD2)")
println("\n" * "="^80)
