...
"""
    plot_co2_distribution(layers, seqs, domain; kwargs...)

Create a poster static plot showing CO2 distribution at the final (or specified) timepoint
